...
exports.deleteUserById = exports.updateUserByID = exports.createNewUser = exports.isValidUserData = exports.getUserByID = exports.validateUserId = exports.getAllUsers = void 0;
...
var validateUserId = function (userId) {
    var uuidRegex = /^[0-9a-fA-F]{8}-[0-9a-fA-F]{4}-4[0-9a-fA-F]{3}-[89abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/;
...
var isValidUserData = function (userData) {
    return (userData.username && typeof userData.username === 'string' &&
        userData.age && typeof userData.age === 'number' &&
        userData.hobbies && Array.isArray(userData.hobbies) &&
        userData.hobbies.every(function (hobby) { return typeof hobby === 'string'; }));
};
exports.isValidUserData = isValidUserData;
var createNewUser = function (userData) {
    var id = (0, uuid_1.v4)();
    var username = userData.username, age = userData.age, hobbies = userData.hobbies;
    var newUser = { id: id, username: username, age: age, hobbies: hobbies };
    users.push(newUser);
    return newUser;
};
...
*/
var updateUserByID = function (id, userData) {
    var userIndex = users.findIndex(function (user) { return user.id === id; });
    if (userIndex !== -1) {
        var updateUser = __assign(__assign({}, users[userIndex]), userData);
...
/***/ "./src/endpoints/handleDeleteUserById.ts":
/*!***********************************************!*\
  !*** ./src/endpoints/handleDeleteUserById.ts ***!
  \***********************************************/
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.handleDeleteUserById = void 0;
var data_1 = __webpack_require__(/*! ../data/data */ "./src/data/data.ts");
var handleDeleteUserById = function (res, url) {
    var userId = url.split('/')[3];
    if (!(0, data_1.validateUserId)(userId)) {
        res.writeHead(400, { 'Content-Type': 'application/json' });
        res.end(JSON.stringify({ error: 'Invalid userId' }));
        return;
    }
    try {
        var user = (0, data_1.getUserByID)(userId);
        if (!user) {
            res.writeHead(404, { 'Content-Type': 'application/json' });
            res.end(JSON.stringify({ error: 'User not found' }));
            return;
        }
        (0, data_1.deleteUserById)(userId);
...
/***/ "./src/endpoints/handleGetAllUsers.ts":
/*!********************************************!*\
  !*** ./src/endpoints/handleGetAllUsers.ts ***!
  \********************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.handleGetAllUsers = void 0;
var data_1 = __webpack_require__(/*! ../data/data */ "./src/data/data.ts");
var handleGetAllUsers = function (res) {
    try {
        var users = (0, data_1.getAllUsers)();
...
/***/ "./src/endpoints/handleGetUserById.ts":
/*!********************************************!*\
  !*** ./src/endpoints/handleGetUserById.ts ***!
  \********************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.handleGetUserById = void 0;
var data_1 = __webpack_require__(/*! ../data/data */ "./src/data/data.ts");
var handleGetUserById = function (res, url) {
    var userId = url.split('/')[3];
    if (!(0, data_1.validateUserId)(userId)) {
        res.writeHead(400, { 'Content-Type': 'application/json' });
        res.end(JSON.stringify({ error: 'Invalid userId' }));
...
/***/ "./src/endpoints/handlePostNewUser.ts":
/*!********************************************!*\
  !*** ./src/endpoints/handlePostNewUser.ts ***!
  \********************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.handlePostNewUser = void 0;
var data_1 = __webpack_require__(/*! ../data/data */ "./src/data/data.ts");
var handlePostNewUser = function (req, res) {
    var data = '';
    ...
    req.on('end', function () {
        try {
            ...
            if (!(0, data_1.isValidUserData)(userData)) {
                res.writeHead(400, { 'Content-Type': 'application/json' });
                res.end(JSON.stringify({ error: 'Request does not contain required fields' }));
                return;
            }
            var newUser = (0, data_1.createNewUser)(userData);
...
exports.handlePostNewUser = handlePostNewUser;


/***/ }),

/***/ "./src/endpoints/handlePutUserById.ts":
/*!********************************************!*\
  !*** ./src/endpoints/handlePutUserById.ts ***!
  \********************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.handlePutUserById = void 0;
var data_1 = __webpack_require__(/*! ../data/data */ "./src/data/data.ts");
var handlePutUserById = function (req, res, url) {
    var userId = url.split('/')[3];
    if (!(0, data_1.validateUserId)(userId)) {
        res.writeHead(400, { 'Content-Type': 'application/json' });
        res.end(JSON.stringify({ error: 'Invalid userId' }));
    ...
    req.on('end', function () {
        try {
            ...
            var updateUser = (0, data_1.updateUserByID)(userId, userData);
            res.writeHead(201, { 'Content-Type': 'application/json' });
...
exports.handlePutUserById = handlePutUserById;
...
var handleGetAllUsers_1 = __webpack_require__(/*! ../endpoints/handleGetAllUsers */ "./src/endpoints/handleGetAllUsers.ts");
var handleGetUserById_1 = __webpack_require__(/*! ../endpoints/handleGetUserById */ "./src/endpoints/handleGetUserById.ts");
var handlePostNewUser_1 = __webpack_require__(/*! ../endpoints/handlePostNewUser */ "./src/endpoints/handlePostNewUser.ts");
var handlePutUserById_1 = __webpack_require__(/*! ../endpoints/handlePutUserById */ "./src/endpoints/handlePutUserById.ts");
var handleDeleteUserById_1 = __webpack_require__(/*! ../endpoints/handleDeleteUserById */ "./src/endpoints/handleDeleteUserById.ts");
exports.server = (0, http_1.createServer)(function (req, res) {
    var method = req.method, url = req.url;
    if (method === 'GET' && url === '/api/users') {
        (0, handleGetAllUsers_1.handleGetAllUsers)(res);
    }
    else if (method === 'GET' && (url === null || url === void 0 ? void 0 : url.startsWith('/api/users/'))) {
        (0, handleGetUserById_1.handleGetUserById)(res, url);
    }
    else if (method === 'POST' && url === '/api/users') {
        (0, handlePostNewUser_1.handlePostNewUser)(req, res);
    }
    else if (method === 'PUT' && (url === null || url === void 0 ? void 0 : url.startsWith('/api/users/'))) {
        (0, handlePutUserById_1.handlePutUserById)(req, res, url);
    }
    else if (method === 'DELETE' && (url === null || url === void 0 ? void 0 : url.startsWith('/api/users/'))) {
        (0, handleDeleteUserById_1.handleDeleteUserById)(res, url);
    }
    else {
        res.writeHead(404, { 'Content-Type': 'application/json' });
